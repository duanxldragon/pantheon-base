...
// Stable marker every generated artifact carries on its first line. The drift
// gate scripts/harness/check-generated.mjs requires it, so a manual edit that
// strips the marker (or hand-writes a registry) fails CI. Keep this exact string
// in sync with GENERATED_MARKER in check-generated.mjs and REPOSITORY_LAYOUT §7.2.
const GENERATED_MARKER = 'Code generated by pantheon low-code generator. DO NOT EDIT.';

function markTemplate(lines) {
  return [`// ${GENERATED_MARKER}`, '', ...lines].join('\n');
}
...
const REGISTRY_TEMPLATES = {
  ...
  backendMenuRegistry: markTemplate([
    'package iam',
    '',
  ...
  frontendBusinessRegistry: markTemplate([
  ...
  frontendComponentRegistry: markTemplate([
...
function i18nTemplate(variableName) {
  return [`// ${GENERATED_MARKER}`, '', `const ${variableName} = {};`, '', `export default ${variableName};`, ''].join('\n');
}
