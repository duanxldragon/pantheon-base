...
const koKRFallback = {
  ...
  'auth.session.hero.totalHint': '현재 감사 범위에 포함된 온라인 또는 해제된 세션 총수입니다.',
  ...
  'system.audit.hero.clearReady': '비우기 준비 완료',
  ...
  'app.preference.tooltip': '환경설정: {{theme}} · {{layout}} · {{language}}',
  ...
  'i18n.create.error': '번역을 생성하지 못했습니다',
  'i18n.list.error': 'i18n 목록을 불러오지 못했습니다',
  ...
  'generator.wizard.moduleName.help': '소문자, 숫자, 밑줄만 사용하세요. 비즈니스 모듈 폴더와 키를 결정합니다.',
  ...
  'system.permission.operation_log.clear': '작업 로그 비우기',
