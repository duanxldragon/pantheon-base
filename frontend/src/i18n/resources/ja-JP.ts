...
const jaJPFallback = {
  ...
  'auth.session.hero.totalHint': '現在の監査範囲に含まれるオンラインまたは無効化済みセッション総数。',
  ...
  'app.preference.tooltip': '設定: {{theme}} · {{layout}} · {{language}}',
  ...
  'i18n.list.error': 'i18n 一覧の読み込みに失敗しました',
  ...
  'generator.wizard.moduleName.help': '小文字、数字、アンダースコアのみを使用してください。業務モジュールのフォルダ名とキーに使われます。',
