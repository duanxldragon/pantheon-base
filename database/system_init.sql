...
(6, 0, 'system.menu.lowcode', '/system/lowcode', '', '', '', 'M', 'code', 'system-lowcode', 'platform.lowcode', 45, 1, 0, 0, '', NOW()),
...
(32, 6, 'system.menu.modules', '/system/modules', 'system/dynamicmodule/ModuleManager', 'system:module:list', '', 'C', 'apps', 'system-modules', 'platform.lowcode', 35, 1, 0, 0, '', NOW()),
(33, 6, 'system.menu.generator', '/system/generator', 'system/generator/ModuleWizard', 'system:generator:use', '', 'C', 'code', 'system-generator', 'platform.lowcode', 40, 1, 0, 0, '', NOW()),
...
(172, 32, 'system.permission.module.register', '', '', '', 'system:module:register', 'F', '', '', 'platform.lowcode', 1, 1, 0, 0, '', NOW()),
(173, 32, 'system.permission.module.unregister', '', '', '', 'system:module:unregister', 'F', '', '', 'platform.lowcode', 2, 1, 0, 0, '', NOW()),
(174, 32, 'system.permission.module.deleteRecord', '', '', '', 'system:module:delete_record', 'F', '', '', 'platform.lowcode', 3, 1, 0, 0, '', NOW()),
(175, 32, 'system.permission.module.purge', '', '', '', 'system:module:purge', 'F', '', '', 'platform.lowcode', 4, 1, 0, 0, '', NOW()),
(176, 32, 'system.permission.module.repair', '', '', '', 'system:module:repair', 'F', '', '', 'platform.lowcode', 5, 1, 0, 0, '', NOW()),
(177, 33, 'system.permission.module.generate', '', '', '', 'system:module:generate', 'F', '', '', 'platform.lowcode', 1, 1, 0, 0, '', NOW()),
(178, 33, 'system.permission.generator.datasourceManage', '', '', '', 'system:generator:datasource:manage', 'F', '', '', 'platform.lowcode', 2, 1, 0, 0, '', NOW()),
