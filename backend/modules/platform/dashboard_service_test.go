...
import (
	...
	login "pantheon-platform/modules/auth/login"
	security "pantheon-platform/modules/auth/security"
	session "pantheon-platform/modules/auth/session"
	dictcfg "pantheon-platform/modules/system/config/dict"
	settingcfg "pantheon-platform/modules/system/config/setting"
