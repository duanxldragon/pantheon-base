...
var canonicalMenuLocaleEntries = map[i18nLocaleKey]i18nCanonicalEntry{
	...
	{Locale: "zh-CN", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "低代码平台"},
	{Locale: "en-US", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "Low-Code Platform"},
	{Locale: "ja-JP", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "ローコードプラットフォーム"},
	{Locale: "ko-KR", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "로우코드 플랫폼"},
	{Locale: "fr-FR", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "Plateforme low-code"},
	...
	{Locale: "zh-CN", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "模块管理"},
	{Locale: "en-US", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "Module Manager"},
	{Locale: "ja-JP", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "モジュール管理"},
	{Locale: "ko-KR", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "모듈 관리"},
	{Locale: "fr-FR", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "Gestion des modules"},
	{Locale: "zh-CN", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "模块生成器"},
	{Locale: "en-US", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "Module Generator"},
	{Locale: "ja-JP", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "モジュール生成器"},
	{Locale: "ko-KR", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "모듈 생성기"},
	{Locale: "fr-FR", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "Générateur de modules"},
