...
var canonicalMenuLocaleEntries = map[i18nLocaleKey]i18nCanonicalEntry{
	...
	{Locale: "en-US", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "Low-Code"},
	{Locale: "ja-JP", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "モジュール開発"},
	{Locale: "ko-KR", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "모듈 개발"},
	{Locale: "fr-FR", Key: "system.menu.lowcode"}:       {Module: "platform.lowcode", Group: "menu", Value: "Développement de modules"},
	...
	{Locale: "en-US", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "Modules"},
	{Locale: "ja-JP", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "モジュール登録"},
	{Locale: "ko-KR", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "모듈 등록"},
	{Locale: "fr-FR", Key: "system.menu.modules"}:       {Module: "platform.lowcode", Group: "menu", Value: "Registre des modules"},
	{Locale: "zh-CN", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "模块生成器"},
	{Locale: "en-US", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "Code Generator"},
	{Locale: "ja-JP", Key: "system.menu.generator"}:     {Module: "platform.lowcode", Group: "menu", Value: "モジュール生成"},
