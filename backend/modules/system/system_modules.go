...
import (
	...
	authsession "pantheon-platform/modules/auth/session"
	audit "pantheon-platform/modules/system/audit"
	dict "pantheon-platform/modules/system/config/dict"
	setting "pantheon-platform/modules/system/config/setting"
	i18n "pantheon-platform/modules/system/i18n"
	menu "pantheon-platform/modules/system/iam/menu"
	permission "pantheon-platform/modules/system/iam/permission"
	role "pantheon-platform/modules/system/iam/role"
	user "pantheon-platform/modules/system/iam/user"
	dept "pantheon-platform/modules/system/org/dept"
	post "pantheon-platform/modules/system/org/post"
