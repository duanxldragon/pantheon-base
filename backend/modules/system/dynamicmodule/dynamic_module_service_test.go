...
func prepareDynamicModuleWorkspace(t *testing.T) string {
	...
	mustMkdirAll(t, filepath.Join(root, "backend", "modules", "system", "menu"))
...
func mustWriteGeneratedRegistryStubs(t *testing.T, root string) {
	...
	mustWriteFile(t, filepath.Join(root, "backend", "modules", "system", "menu", "generated_component_registry.go"), "package system\n")
