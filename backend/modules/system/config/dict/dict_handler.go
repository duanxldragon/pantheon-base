...
const (
	dictParamInvalidMessageKey  = "param.invalid"
	dictRequestFailedMessageKey = "request.failed"
	dictParamID                 = "id"
	dictImportFileField         = "file"
	dictDeletedField            = "deleted"
	dictUpdatedCountField       = "updatedCount"
)
...
func (h *DictHandler) GetDictTypeList(c *gin.Context) {
	...
	if err := c.ShouldBindQuery(&query); err != nil {
		common.Fail(c, common.CodeParamInvalid, dictParamInvalidMessageKey)
		return
	}
...
func (h *DictHandler) CreateDictType(c *gin.Context) {
	...
	if err != nil {
		common.FailWithError(c, common.CodeError, err, dictRequestFailedMessageKey)
		return
	}
...
func (h *DictHandler) UpdateDictType(c *gin.Context) {
	...
	typeID, err := parseDictUintPathParam(c, dictParamID)
	if err != nil {
		common.Fail(c, common.CodeParamInvalid, dictParamInvalidMessageKey)
		return
	}
...
func (h *DictHandler) DeleteDictType(c *gin.Context) {
	...
	common.Success(c, gin.H{dictDeletedField: true})
}
...
func (h *DictHandler) BatchUpdateDictTypeStatus(c *gin.Context) {
	...
	common.Success(c, gin.H{dictUpdatedCountField: updatedCount})
}
...
func (h *DictHandler) UpdateDictItem(c *gin.Context) {
	...
	itemID, err := parseDictUintPathParam(c, dictParamID)
	if err != nil {
		common.Fail(c, common.CodeParamInvalid, dictParamInvalidMessageKey)
		return
	}
...
func (h *DictHandler) ImportDictTypes(c *gin.Context) {
	...
	fileHeader, err := c.FormFile(dictImportFileField)
	if err != nil {
...
func parseDictUintPathParam(c *gin.Context, key string) (uint64, error) {
