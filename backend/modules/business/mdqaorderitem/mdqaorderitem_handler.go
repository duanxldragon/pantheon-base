...
// GetMdqaorderitemOptions 获取关系选项
func (h *MdqaorderitemHandler) GetMdqaorderitemOptions(c *gin.Context) {
	options, err := h.service.ListMdqaorderitemOptions()
	if err != nil {
		common.Fail(c, common.CodeError, "mdqaorderitem.options.error")
		return
	}
