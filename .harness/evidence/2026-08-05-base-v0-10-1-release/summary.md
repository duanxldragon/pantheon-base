...
now rejects every non-success result from every required dependency, including
Go Lint. Historical release-task linkage is reconciled without inventing
missing evidence, and the repository now tracks its OpenSpec skeleton.
