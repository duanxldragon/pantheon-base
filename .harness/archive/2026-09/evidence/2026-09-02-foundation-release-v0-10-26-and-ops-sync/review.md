...
- RESOLVED: hosted `golangci-lint --new-from-rev` found 10 Go files with import-order formatting drift. `gofmt` changed only whitespace in those files; the subsequent full Windows CGO race gate passed.
