...
Local static gates are clear. Runtime approval remains intentionally deferred to the hosted Core Smoke and required GitHub checks. No `solo-override` bypass is permitted.
