...
node scripts/harness/check-task-packet.mjs --root .   # all task packets; pre-template docs would be listed in config/task-packet-legacy-docs.json, which is now empty
