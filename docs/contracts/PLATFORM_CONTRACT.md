...
- 参考 [PLATFORM_ACCEPTANCE_MATRIX_20260430_UI_MIGRATION.md](D:/workspace/go/pantheon-platform/docs/acceptances/PLATFORM_ACCEPTANCE_MATRIX_20260430_UI_MIGRATION.md)
- 参考 [PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_TEMPLATE.md](D:/workspace/go/pantheon-platform/docs/acceptances/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_TEMPLATE.md)
