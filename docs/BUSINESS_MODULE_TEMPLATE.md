...
- `docs/FRONTEND_PAGE_TEMPLATES.md`
...
| `docs/MODULE_CONTRACT.md` | 模块如何注册与接入 | 某个业务模块内部的业务设计 |
| `docs/PERMISSION_MODEL.md` | 平台权限分层与命名规范 | 某个业务模块自己的权限清单 |
| `docs/ERROR_CODE_AND_I18N.md` | 错误 key 与 i18n 责任分工 | 某个业务模块的文案清单 |
| `docs/FRONTEND_PAGE_TEMPLATES.md` | 页面骨架模板 | 某个业务模块具体字段和按钮 |
| `docs/ACCEPTANCE_CHECKLIST.md` | 阶段验收标准 | 模块设计结构本身 |
