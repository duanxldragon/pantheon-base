...
- 首个基准记录见 `docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_20260430_LAYOUT_UNIFICATION.md`。
- PR 描述正文模板见 `docs/PLATFORM_SHELL_PR_TEMPLATE.md`。
...
- 关联文档：
  ...
  - `docs/PLATFORM_ACCEPTANCE_MATRIX_20260430_UI_MIGRATION.md`
