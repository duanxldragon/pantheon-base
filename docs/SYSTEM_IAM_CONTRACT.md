...
- [PERMISSION_MODEL.md](D:/workspace/go/pantheon-platform/docs/PERMISSION_MODEL.md)
- [MODULE_CONTRACT.md](D:/workspace/go/pantheon-platform/docs/MODULE_CONTRACT.md)
- [FRONTEND_PAGE_TEMPLATES.md](D:/workspace/go/pantheon-platform/docs/FRONTEND_PAGE_TEMPLATES.md)
- [ERROR_CODE_AND_I18N.md](D:/workspace/go/pantheon-platform/docs/ERROR_CODE_AND_I18N.md)
...
- 任何新权限模型变更，不得绕开 [PERMISSION_MODEL.md](D:/workspace/go/pantheon-platform/docs/PERMISSION_MODEL.md)
...
- [DYNAMIC_MENU_MATURITY_20260422.md](D:/workspace/go/pantheon-platform/docs/DYNAMIC_MENU_MATURITY_20260422.md)
