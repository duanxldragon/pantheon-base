...
- [ ] 已附双模式验收文档链接
- [ ] 双模式验收文档基于 `docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_TEMPLATE.md`
...
- PR 正文模板：`docs/PLATFORM_SHELL_PR_TEMPLATE.md`
- PR 正文样例：`docs/PLATFORM_SHELL_PR_SAMPLE_20260430_LAYOUT_UNIFICATION.md`
- 双模式验收模板：`docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_TEMPLATE.md`
- 双模式验收基准样例：`docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_20260430_LAYOUT_UNIFICATION.md`
