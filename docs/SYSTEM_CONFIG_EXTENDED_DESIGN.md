...
- `docs/DICT_AND_SETTING_DESIGN.md`
- `docs/ERROR_CODE_AND_I18N.md`
- `docs/LOWCODE_GENERATOR_GUIDE.md`
...
- 单独补 `docs/I18N_MODULE_DESIGN.md`
...
- 单独补 `docs/UPLOAD_AND_STORAGE_DESIGN.md`
...
- 单独补 `docs/DYNAMIC_MODULE_GOVERNANCE_DESIGN.md`
...
| 文档 | 负责什么 | 与本文关系 |
| :--- | :--- | :--- |
| `docs/DICT_AND_SETTING_DESIGN.md` | 字典与设置细节 | 是 `dict / setting` 子域细化文档 |
| `docs/ERROR_CODE_AND_I18N.md` | 错误 key 与 i18n 责任边界 | 是 `i18n` 子域的重要配套文档 |
| `docs/LOWCODE_GENERATOR_GUIDE.md` | 生成器使用与链路说明 | 是 `generator / dynamicmodule` 的操作型文档 |
| `docs/ACCEPTANCE_CHECKLIST.md` | 统一验收门槛 | 应补齐 `system/config` 扩展能力验收 |
