...
- `docs/PLATFORM_SHELL_PR_CHECKLIST_SNIPPET.md`
...
- 双模式验收记录：`<doc link>`
- 验收矩阵：`docs/PLATFORM_ACCEPTANCE_MATRIX_20260430_UI_MIGRATION.md`
- 验收清单：`docs/ACCEPTANCE_CHECKLIST.md`
- 工作流要求：`docs/WORKFLOW.md`
...
- 验收矩阵：`docs/PLATFORM_ACCEPTANCE_MATRIX_20260430_UI_MIGRATION.md`
- 验收模板：`docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_TEMPLATE.md`
...
- 对应 PR 正文样例：`docs/PLATFORM_SHELL_PR_SAMPLE_20260430_LAYOUT_UNIFICATION.md`
- 可直接粘贴的 checklist 片段：`docs/PLATFORM_SHELL_PR_CHECKLIST_SNIPPET.md`
...
- 双模式验收文档：`docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_20260430_LAYOUT_UNIFICATION.md`
...
- 双模式验收记录：`docs/PLATFORM_SHELL_DUAL_MODE_ACCEPTANCE_20260430_LAYOUT_UNIFICATION.md`
- 验收矩阵：`docs/PLATFORM_ACCEPTANCE_MATRIX_20260430_UI_MIGRATION.md`
- 验收清单：`docs/ACCEPTANCE_CHECKLIST.md`
- 工作流要求：`docs/WORKFLOW.md`
