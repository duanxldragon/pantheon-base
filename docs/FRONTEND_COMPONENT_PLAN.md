...
- `docs/FRONTEND_PAGE_TEMPLATES.md` 的页面骨架模板
...
| 文档 | 负责什么 | 不负责什么 |
| :--- | :--- | :--- |
| `docs/FRONTEND_UI_SPEC.md` | 视觉、布局、交互原则 | 具体组件清单与沉淀顺序 |
| `docs/FRONTEND_PAGE_TEMPLATES.md` | 页面模板与骨架模式 | 组件分层和目录规划 |
| `docs/MODULE_CONTRACT.md` | 模块如何注册 | 组件如何抽象 |
| `docs/BUSINESS_MODULE_TEMPLATE.md` | 业务模块页面应写什么 | 公共组件应如何分层 |
