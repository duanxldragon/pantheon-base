...
- Auth 拆分设计：`docs/AUTH_MODULE_DESIGN.md`
- 前端 UI 细则：`docs/FRONTEND_UI_SPEC.md`
- 后台 UI 专项整改方案：`docs/BACKOFFICE_UI_REMEDIATION_PLAN_20260423.md`
- 平台仪表盘设计：`docs/PLATFORM_DASHBOARD_DESIGN.md`
- 模块契约：`docs/MODULE_CONTRACT.md`
- 权限模型：`docs/PERMISSION_MODEL.md`
- 错误码与多语言：`docs/ERROR_CODE_AND_I18N.md`
- 前端页面模板：`docs/FRONTEND_PAGE_TEMPLATES.md`
- 前端组件规划：`docs/FRONTEND_COMPONENT_PLAN.md`
- 安全中心设计：`docs/SECURITY_CENTER_DESIGN.md`
- 字典与系统设置：`docs/DICT_AND_SETTING_DESIGN.md`
- 业务模块设计模板：`docs/BUSINESS_MODULE_TEMPLATE.md`
- 设计与实现验收清单：`docs/ACCEPTANCE_CHECKLIST.md`
...
- `docs/PLATFORM_DASHBOARD_DESIGN.md`
...
- `docs/DYNAMIC_MENU_MATURITY_20260422.md` 已明确动态菜单成熟度结论与下一阶段蓝图。
...
1. `docs/MODULE_CONTRACT.md`
2. `docs/PERMISSION_MODEL.md`
3. `docs/ERROR_CODE_AND_I18N.md`
4. `docs/FRONTEND_COMPONENT_PLAN.md`
5. `docs/BUSINESS_MODULE_TEMPLATE.md`
