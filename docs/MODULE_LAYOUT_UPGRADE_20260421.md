...
如需在老环境执行实际升级，请配合 `docs/UPGRADE_RUNBOOK_20260421.md` 与 `docs/UPGRADE_EXECUTION_CHECKLIST_20260421.md` 一起使用；本文只负责解释边界与目录变化，不替代执行清单。
...
- `docs/UPGRADE_RUNBOOK_20260421.md`
- `docs/UPGRADE_EXECUTION_CHECKLIST_20260421.md`
